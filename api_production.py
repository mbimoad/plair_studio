...
def get_quote():
    try:
        ...
        return jsonify({"message": "Quote request submitted successfully"})
...
def newsletter():
    try:
        ...
        return jsonify({"message": "Newsletter subscription successful"})
    except Exception as e:
        return jsonify({"error": str(e)}), 500
...
def send_email(subject, body):
    try:
        ...
        msg = Message(subject=subject, body=body, recipients=['danielcaminero@plairstudio.com'])
